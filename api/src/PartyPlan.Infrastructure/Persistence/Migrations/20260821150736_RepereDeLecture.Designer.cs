...
namespace PartyPlan.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260821150736_RepereDeLecture")]
    partial class RepereDeLecture
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PartyPlan.Modules.Users.Domain.TotpRecoveryCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_totp_recovery_codes");

                    b.HasIndex("CodeHash")
                        .IsUnique()
                        .HasDatabaseName("ix_totp_recovery_codes_code_hash");

                    b.HasIndex("UserId", "UsedAt")
                        .HasDatabaseName("ix_totp_recovery_codes_user_id_used_at");
            ...
            modelBuilder.Entity("PartyPlan.Modules.Users.Domain.TotpRecoveryCode", b =>
                {
                    b.HasOne("PartyPlan.Modules.Users.Domain.User", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_totp_recovery_codes_users_user_id");
                });
