  ...
  group('Tableau de bord', () {
    ...
    testWidgets(
      ...
      (tester) async {
        await _monter(
          tester,
          membres: [
            membre(nom: 'Moi', statut: StatutPresence.inconnu, cestMoi: true),
          ],
        );
    ...
    testWidgets('n’insiste plus une fois la réponse donnée', (tester) async {
      await _monter(
        tester,
        membres: [
          membre(nom: 'Moi', statut: StatutPresence.present, cestMoi: true),
        ],
      );
    ...
    testWidgets('RG-PRES-03 : les peut-être sont annoncés à part', (
      tester,
    ) async {
      await _monter(tester);
    ...
    testWidgets('la section de partage est cachée à un simple membre', (
      ...
      await _monter(tester, membres: [membre(nom: 'Moi', cestMoi: true)]);
